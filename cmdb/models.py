...
class Server_Device(models.Model):
    ...
    hostname = models.CharField(u'主机名称', max_length=100, unique=True)
    ...
    # 私网IP，可以为空
    ip = models.CharField(u'内网IP', max_length=200, blank=True)
    # 定义mac地址字段
    ...
    cpu_cores = models.CharField(u'CPU核数', max_length=100, blank=True)
    cpu_count = models.CharField(u'CPU数量', max_length=100, blank=True)

    # 关联主机组
    group = models.ForeignKey(Server_Group, max_length=255, blank=True, null=True, verbose_name='主机组')
